...
class tabbody extends StatefulWidget {
  ...
  @override
  State<tabbody> createState() => _desktopbodyState();
}

class _desktopbodyState extends State<tabbody> {
    ...
    return SafeArea(
      ...
      appBar: GradientAppBar(
        ...
        actions: [
          ...
          InkWell(
            onTap: () async {
              String email = Uri.encodeComponent("ramanareddy@needmoto.in");
          ...
          InkWell(
            onTap: () {
              setState(() {
                _makePhoneCall('tel:+91886666469');
              });
            },
            child: Padding(
              padding: const EdgeInsets.only(top: 15),
          ...
          children: [
                ...
                children: [
                  SizedBox(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Image(image: AssetImage('assets/device.webp')),
                          Text(
                            'GPS TRACKER(OBD)',
                            style: TextStyle(
            ...
            Container(
                decoration: BoxDecoration(
                  ...
                  // Colors.lightBlue,
                  // Colors.yellowAccent,
                  Colors.white, Colors.white60, Colors.white60, Colors.white60,
